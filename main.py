...
class ShipMovementKeyPressedHandler(GameKeyboardHandler):
    def handle(self, event):
        if event.keysym == 'Left':
            self.game_app.ship.start_turn('LEFT')
        elif event.keysym == 'Right':
            self.game_app.ship.start_turn('RIGHT')
        elif event.char == ' ':
            self.game_app.ship.fire()
        else:
            super().handle(event)
...
class ShipMovementKeyReleasedHandler(GameKeyboardHandler):
    def handle(self, event):
        if event.keysym == 'Left':
            self.game_app.ship.stop_turn('LEFT')
        elif event.keysym == 'Right':
            self.game_app.ship.stop_turn('RIGHT')
        else:
            super().handle(event)
